<template>
  <div class="w-full flex flex-col space-y-8">
    ...
    <section class="bg-gray-200 py-24 space-y-10 text-center">
      <h2 class="text-3xl md:text-4xl font-bold">CONTACT</h2>
      <div class="mx-auto w-[80%] text-gray-600 max-w-6xl">
        <p
          class="text=center text-3xl md:text-4xl font-bold font-mono leading-10"
        >
          If you have something to tell me, or you've got some work for me,
          you've found the perfect person.
        </p>
        <p
          class="text=center text-3xl md:text-4xl font-bold font-mono leading-12 text-gray-800"
        >
          jimohsodiq301@gmail.com
        </p>
      </div>
    </section>
...
-->
      ...
      <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-12">
          ...
          <p class="lg:w-2/3 mx-auto leading-relaxed text-base">
            Lorem ipsum dolor sit, amet ullam animi totam soluta facere
            accusamus?
          </p>
        </div>
    ...
    <section class="py-20 bg-white">
      <div class="container max-w-6xl mx-auto">
        <h2 class="text-4xl font-bold tracking-tight text-center">My Works</h2>
        <p class="mt-2 text-lg text-center text-gray-600">
          Check out a list of some of my works below.
        </p>
        <div
        ...
        >
          ...
          >
            ...
            <h4 class="text-xl font-medium text-gray-700">Write topic</h4>
            <p class="text-base text-center text-gray-500">
              llorem ipsum sit amit dolor lorem sofd ddfjd div and said not.
            </p>
          </div>
          <div
          ...
          >
            ...
            <h4 class="text-xl font-medium text-gray-700">Write topic</h4>
            <p class="text-base text-center text-gray-500">
              lorem ipsum sit amit dolor lorem sofd ddfjd div and said not.
            </p>
          </div>
          <div
            class="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl"
          ...
          >
            ...
            <h4 class="text-xl font-medium text-gray-700">Writetopic</h4>
            <p class="text-base text-center text-gray-500">
              llorem ipsum sit amit dolor lorem sofd ddfjd div and said not.
            </p>
          </div>
    ...
    <section class="w-full px-6 pb-12 antialiased bg-gray-200">
