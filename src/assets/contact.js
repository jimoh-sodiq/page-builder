export const Contacts = [
  ...
  {
    category: "Contact",
    id: "contact__2", // id is mandatory
    label: "<b>contact</b>", // You can use HTML/SVG inside labels
    attributes: { class: "gjs-block-section" },
    content: `<section class="bg-gray-800 text-gray-100 px-8 py-12">
        <div
  ...
  {
    category: "Contact",
    id: "contact__3", // id is mandatory
    label: "<b>contact</b>", // You can use HTML/SVG inside labels
    attributes: { class: "gjs-block-section" },
    content: `<section class="bg-gray-200 py-24 space-y-10 text-center">
